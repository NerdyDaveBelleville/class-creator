...
# Custom CSS with Nerdy.com's modern color scheme
st.markdown("""
    <style>
    ...
    /* Custom header banner - Modern Nerdy style */
    .header-banner {
        background: linear-gradient(135deg, #1e40af 0%, #1e3a8a 20%, #6366f1 80%, #8b5cf6 100%);
        padding: 2rem;
        display: flex;
        align-items: center;
        margin-bottom: 2rem;
    ...
    /* Temporary success message styling - Modern */
